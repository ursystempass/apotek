                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('pembelian_id') is-invalid @enderror"
                                ...
                                @foreach ($pembelians as $pembelian)
                                    <option value="{{ $pembelian->id }}" @if ($detailpembelian->pembelian_id == $pembelian->id) selected @endif>
                                        {{ $pembelian->nonota_beli }}</option>
                                @endforeach
                            </select>
                            @error('pembelian_id')
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tgl_kadaluarsa') is-invalid @enderror"
                                id="exampleInputTglKadaluarsa" name="tgl_kadaluarsa"
                                value="{{ old('tgl_kadaluarsa', $detailpembelian->tgl_kadaluarsa ? \Carbon\Carbon::parse($detailpembelian->tgl_kadaluarsa)->format('Y-m-d') : '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('harga_beli') is-invalid @enderror"
                                ...
                                value="{{ $detailpembelian->harga_beli }}">
                            @error('harga_beli')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('jumlah_beli') is-invalid @enderror"
                                ...
                                value="{{ $detailpembelian->jumlah_beli }}">
                            @error('jumlah_beli')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('sub_total_beli') is-invalid @enderror"
                                ...
                                value="{{ $detailpembelian->sub_total_beli }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('persen_magin_jual') is-invalid @enderror"
                                ...
                                value="{{ $detailpembelian->persen_magin_jual }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('obat_id') is-invalid @enderror" id="exampleInputObat"
                                ...
                                @foreach ($obats as $obat)
                                    <option value="{{ $obat->id }}" @if ($detailpembelian->obat_id == $obat->id) selected @endif>
                                        {{ $obat->name }}</option>
                                @endforeach
                            </select>
                            @error('obat_id')
